...
contract SupplyMesh {
  ...
  function serializeRequestObject(IndexValue memory value) internal pure returns (string memory) {
    return string(abi.encodePacked("{", value.keyIndex, ",",
          value.price, ",",
          value.lowest_bidder, ",",
          value.next_lowest_bidder, ",",
          value.balance, ",",
          value.poster, ",",
          value.claimed, ",",
          value.accepted, ",",
